...
<%
	...
	int pgnoPrev = Math.max(pgno - 1, 0), pgnoNext = pgno + 1;
...
<body>
	<div class="container">
		...
		<div style="float: right">
			<a href="browseStu18340146.jsp?pgno=<%=pgnoPrev%>&pgcnt=<%=pgcnt%>">上一页</a>
			<a href="browseStu18340146.jsp?pgno=<%=pgnoNext%>&pgcnt=<%=pgcnt%>">下一页</a>
		</div>
	</div>
</body>
</html>
