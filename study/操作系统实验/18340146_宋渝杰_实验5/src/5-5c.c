/*
	gcc -march=i386 -m16 -mpreferred-stack-boundary=2 -ffreestanding -fno-PIE -masm=intel -c 5-5c.c -o 5-5c.o
	nasm -felf 5-5asm.asm -o 5-5asm.o
	ld -m elf_i386 -N --oformat binary -Ttext 0x7e00 5-5asm.o 5-5c.o -o 5-5.bin
	nasm 5-5os.asm -o 5-5os.bin
	...
	dd if=5-5.bin of=syjos.img seek=1 conv=notrunc
	dd if=5-5os.bin of=syjos.img conv=notrunc	
