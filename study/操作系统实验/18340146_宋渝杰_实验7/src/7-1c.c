/*
	...
	dd if=7.com of=syjos.img seek=27 conv=notrunc
	dd if=7-1.bin of=syjos.img seek=1 conv=notrunc
	dd if=7-1os.bin of=syjos.img conv=notrunc	
...
void main() {
	...
	qi = q;
	qi->statu = 1;
	for (int i=0; i<4; i++) (qe+i)->statu = 0;
	...
	const char help[] = "help", exe[] = "exe", exes[] = "exes", exit[] = "exit", ls[] = "ls", clear[] = "cls", run[] = "runs", fork[] = "fork";
	static char helpstr[] =
